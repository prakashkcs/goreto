...
$PRIVACY_COLS = [
    ...
    'subscriber_only_dm',
    'privacy_show_name_random_call',
    'privacy_feed_action_subscribe',
    'cross_border_consent',
    'cross_gender_proposal',
];
...
function ensure_privacy_columns(PDO $pdo, array $privacyCols): void
{
    ...
    try {
        ...
        $defaults = [
            ...
            'privacy_direct_random_call'      => 0,  // default OFF: require both to tap Start
            'privacy_allow_direct_call'       => 0,  // show name on random call: default OFF
            ...
            'privacy_share_distance'          => 0,  // default OFF
            'privacy_nearby_visible'          => 1,
            'privacy_nearby_alert'            => 1,
            'subscriber_only_dm'              => 0,
            'privacy_show_name_random_call'   => 0,  // default OFF
            'privacy_feed_action_subscribe'   => 0,
            'cross_border_consent'            => 0,
            'cross_gender_proposal'           => 1,
        ];
