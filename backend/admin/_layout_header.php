  ...
  <div class="wrap">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <?= nav_link('streaks.php', 'streaks', $activeNav, 'Streaks') ?>
        ...
        <?= nav_link('moderation_queue.php', 'moderation_queue', $activeNav, 'Moderation Queue', admin_badge_html((int) ($adminAlertCounts['reports'] ?? 0) + (int) ($adminAlertCounts['sound_reports'] ?? 0))) ?>
        ...
        <?= nav_link('content_moderation.php', 'content_moderation', $activeNav, 'Content Moderation', admin_badge_html((int) ($adminAlertCounts['moderation_blocked'] ?? 0))) ?>
        <?= nav_link('nsfw_review.php', 'nsfw_review', $activeNav, 'NSFW Review') ?>
        ...
        <?= nav_link('settings.php', 'settings', $activeNav, '&#9881; Settings') ?>
      </nav>
    </aside>
